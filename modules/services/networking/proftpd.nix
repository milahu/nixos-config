...
<Anonymous /home/user/src/project>
  ...
  config = mkIf cfg.enable {
    ...
    # If you really must access root via FTP, then use mkOverride or userlistDeny
    # = false and whitelist root
    #services.proftpd.userlist = if cfg.userlistDeny then ["root"] else [];
...
#        RuntimeDirectory = daemon;
    ...
    #security.pam.services.proftpd.text = mkIf (cfg.enableVirtualUsers && cfg.userDbPath != null)''
