{
  ...
  */
  ...
  outputs = { self, ... } @ inputs: rec {
    ...
    # hostname alias for fresh nixos install
    nixosConfigurations.nixos = nixosConfigurations.laptop;

    nixosConfigurations.laptop = inputs.nixpkgs.lib.nixosSystem rec {
